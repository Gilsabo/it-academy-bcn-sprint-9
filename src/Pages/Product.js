...
const Product = () => {
  ...
  useEffect(() => {
    const filtered = fetchData.filter((data) => data.id === parseInt(id) + 1);
    ...
    <div>
      ...
      {detailsIdProduct.length > 0 && (
        <div className="product">
          <img src={detailsIdProduct[0].image} alt="cloth" />
          ...
          <div className="rating">
            ...
            <div className="description">Description : {detailsIdProduct[0].description}</div>
